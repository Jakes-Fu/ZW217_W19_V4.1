...
#if defined(WORD_CARD_SUPPORT) || defined(HANZI_CARD_SUPPORT) || defined(FORMULA_SUPPORT)
...
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_formula_list_ms =
{
    3*FORMULA_LIST_ITEM_HIGHT, 3*FORMULA_LIST_ITEM_HIGHT,
    {
        ...
        {
            0,
            {0.4*ZMT_LIST_LINE_WIDTH, 0, 1.4*ZMT_LIST_LINE_WIDTH, 2.5*ZMT_LIST_LINE_HIGHT},
            {0.4*ZMT_LIST_LINE_WIDTH, 0, 1.4*ZMT_LIST_LINE_WIDTH, 2.5*ZMT_LIST_LINE_HIGHT},
            0, 0
        }, 
        //text
        {
            0,
            {1.6*ZMT_LIST_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 2.5*ZMT_LIST_LINE_HIGHT},
            {1.6*ZMT_LIST_LINE_WIDTH, 0, MMI_MAINSCREEN_WIDTH, 2.5*ZMT_LIST_LINE_HIGHT},
            SONG_FONT_16, SONG_FONT_16,
            0, 0
        },      
