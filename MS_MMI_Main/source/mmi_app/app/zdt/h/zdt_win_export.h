...
//****** 列表菜单***************//
		...
		#define MEUN_PHONEBOOK {1, TXT_QRCODE, res_app_ic_contact,  MMIZDT_Open2VMSelectWin}
		#define MEUN_CAMERA {0, TXT_LAUNCHER_CAMERA_TITLE, res_app_ic_camera,  MMI_CreateWordWin} //相机
        #ifdef ZDT_PLAT_YX_SUPPORT_VOICE
            #ifdef ZDT_PLAT_YX_SUPPORT_FRIEND
		    #define MEUN_WECHART {1, TXT_QRCODE, res_app_ic_wechat,  MMIZDT_OpenChatGroupWin}//微聊
            #else       //ZDT_PLAT_YX_SUPPORT_FRIEND
            #define MEUN_WECHART {1, TXT_QRCODE, res_app_ic_wechat,  MMIAPIMENU_EnterTinyChat}//微聊
            #endif      // end ZDT_PLAT_YX_SUPPORT_FRIEND
        #endif // end ZDT_PLAT_YX_SUPPORT_VOICE
		#define MEUN_GALLERY {0, TXT_QRCODE, res_app_ic_gallery, MMI_CreateMathMnemonicWin} //相册
		#define MEUN_QRCODE {0, TXT_QRCODE, res_app_ic_qrcode,MMI_CreateHanziWin}

		#define MEUN_SETTINGS {0, TXT_QRCODE, res_app_ic_settings,WatchSET_MainWin_Enter}
    ...
    #else
        #define MEUN_PHONEBOOK {1, res_app_ic_contact,  MMI_CreateHanziWin}
        #define MEUN_CAMERA {0, res_app_ic_camera,  MMI_CreateWordWin} //相机
        #ifdef ZDT_PLAT_YX_SUPPORT_VOICE
        #ifdef ZDT_PLAT_YX_SUPPORT_FRIEND
        ...
        #endif
        #define MEUN_GALLERY {0, res_app_ic_gallery, MMI_CreateMathMnemonicWin} //相册
