...
LOCAL GUI_RECT_T formula_left_button_rect = {9, MMI_MAINSCREEN_HEIGHT - 1*FORMULA_LINE_HIGHT, 115, MMI_MAINSCREEN_HEIGHT - 2};
LOCAL GUI_RECT_T formula_right_button_rect = {125, MMI_MAINSCREEN_HEIGHT - 1*FORMULA_LINE_HIGHT, MMI_MAINSCREEN_WIDTH-9, MMI_MAINSCREEN_HEIGHT - 2};
...
LOCAL void FormulaMnemonicWin_OPEN_WINDOW(MMI_WIN_ID_T win_id)
{
    ...
    MMI_TEXT_ID_T text_id[FORMULA_APP_COUNT_MAX] = {TXT_MATH_MNEMONIC_TITLE, TXT_FORMULA_TITLE};
    ...
    for(i = 0; i < 2;i++)
    {
        ...
        item_data.item_content[0].item_data.image_id = IMG_FORMULA_ITEM_BG;
