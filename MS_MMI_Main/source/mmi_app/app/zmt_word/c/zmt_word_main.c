...
#define word_title_rect {18, 0, MMI_MAINSCREEN_WIDTH-22, WORD_CARD_LINE_HIGHT}
...
#define word_dir_rect {5*WORD_CARD_LINE_WIDTH-28, 0, MMI_MAINSCREEN_WIDTH, WORD_CARD_LINE_HIGHT}
